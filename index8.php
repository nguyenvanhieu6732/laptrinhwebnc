...
<head>
    ...
    <link rel="stylesheet" href="./assets/css/styles8.css" />
    ...
    <main>
        ...
        <div class="main-list-product">
            <p style="padding: 20px 15px">
                Trang chủ - Khuyến mại - GIẢM GIÁ 15% TẤT CẢ CÁC DÒNG VÍ TẠI
                CỬA HÀNG
            </p>
            <p style="font-size: 28px; text-align: center; padding: 12px 0">
                GIẢM GIÁ 15% TẤT CẢ CÁC DÒNG VÍ TẠI CỬA HÀNG
            </p>
            <hr style="color: #ccc; margin-bottom: 35px" />
            ...
            <div class="group-product">
                <div class="product-item">
                    <img src="https://pos.nvncdn.net/f0fdc3-116319/ps/20220321_SUyVHRYXAh6dNXBOEryu8dH3.jpg"
                        alt="Ví Trang Trí Khóa The Maze" class="img-product" />
                    <div class="price-product">
                        <span style="padding-right: 15px; color: #f15b67">450.500</span>
                        <span><strike>530.000</strike></span>
                    </div>
                    ...
                    <div class="sale-product" st>-15%</div>
                </div>
